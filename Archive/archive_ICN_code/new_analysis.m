...
fast_trials_stim = squeeze(peaks_all_raw(nr+1:98-nr,2,ipat));
slow_trials_stim = squeeze(peaks_all_raw(nr+1:98-nr,1,ipat));
fast_trials_rec = squeeze(peaks_all_raw(nr+99:196-nr,2,ipat));
slow_trials_rec = squeeze(peaks_all_raw(nr+99:196-nr,1,ipat));
for a = 1:length(ipat)
