...
% stimulation 
% Script optimized for new task version: Less blocks with more trials
...
for i_file=1:n_files
    ...
    for i_cond = 1:n_conds
        ...
        for i_trial=1:n_trials
            ...
            mask = data(:,8) == blocks_cond(i_cond) & data(:,9) == i_trial;
        ...
        %% After all trials from one condition are processed 
    ...
    for i_cond = 1:n_conds
        ...
        for i_trial=1:n_trials
            % Get the data from one trial
            mask = data(:,8) == blocks_cond_recov(i_cond) & data(:,9) == i_trial;
            data_trial = data(mask, :);
